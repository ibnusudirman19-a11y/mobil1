  ...
  routes: {
      ...
      onBeforeUpload: async () => {
        ...
        return {
          generateObjectInfo: ({ file }) => ({
            key: `projects/zWg2oUSbQDFqEU8RAhkxi/uploads/${uploadId}-${file.name}`,
          }),
        };
      },
    }),
    ...
    avatar: route({
      ...
      onBeforeUpload: async () => {
        ...
        return {
          generateObjectInfo: ({ file }) => ({
            key: `projects/zWg2oUSbQDFqEU8RAhkxi/avatars/${uploadId}-${file.name}`,
          }),
        };
      },
    }),
    ...
    documents: route({
      ...
      onBeforeUpload: async () => {
        ...
        return {
          generateObjectInfo: ({ file }) => ({
            key: `projects/zWg2oUSbQDFqEU8RAhkxi/documents/${uploadId}-${file.name}`,
          }),
        };
      },
    }),
